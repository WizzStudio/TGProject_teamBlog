...
@section('content')
    <div class="container">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="info-box">
                <a href="{{ route('tag.index') }}"><span class="info-box-icon bg-blue-gradient"><li class="fa fa-tags"></li></span></a>
                <div class="info-box-content">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="info-box">
                <a href="{{ route('group.index') }}"><span class="info-box-icon bg-yellow-gradient"><li class="fa fa-users"></li></span></a>
                <div class="info-box-content">
            ...
            <table class="table table-striped" id="hot_post">
                ...
                @foreach($posts as $each_post)
                    <tr>
                        ...
                        <th><a href="{{ route('member.show', ['id' => $each_post->user->id]) }}">
                                {{ $each_post->user->name }}</a></th>
